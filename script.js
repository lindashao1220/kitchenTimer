...
let beyondInput = 26; // Beyond duration in minutes
...
// Instructions Mode
let landingVisuals; // Instance of LandingVisuals
...
function setup() {
  ...
  // Initialize landing visuals (replacing old blobs)
...
function drawSetup() {
  ...
  textSize(16);
  text("Keys: 1/2 (Duration), SPACE (Start)", width / 2, height / 2 + maxRadius + 80);
}
